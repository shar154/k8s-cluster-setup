...
export class EndpointStack extends Stack {
  constructor(
    ...
    const bucketName =
      process.env.LEARNING_BUCKET ||
      'arn:aws:s3:::learning-the-cloud-81927n1yd9';
    ...
    const ssmMessagesEndpoint = props.vpc.addInterfaceEndpoint(
      'SsmMessagesEndpoint',
      {
    ...
    const ec2MessagesEndpoint = props.vpc.addInterfaceEndpoint(
      'Ec2MessagesEndpoint',
      {
